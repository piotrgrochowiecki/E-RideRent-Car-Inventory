...
CMD java -jar /home/ERideRent_Car_Inventory/E-RideRent-Car-Inventory.jar --spring.datasource.url=jdbc:mysql://CarInventoryServiceDB:3312/car_inventory_service_db